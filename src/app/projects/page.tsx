    ...
    return (
     <div className="projectContainer flex w-full min-h-[500px] p-10 flex-wrap gap-7">
       ...
       <div className="projectCard w-[325px] h-[325px] min-h-[325px] bg-[#161616] rounded-[12px] border-3 border-transparent mt-24 transition duration-500 ml-8 hover:scale-110 hover:-translate-y-1 hover:border-[#b74b4b] hover:shadow-[0_0_25px_#b74b4b]">
        ...
        <Link href="https://simplecalculatorbywaseemahmed.vercel.app/"><button className="projectlink ml-2 h-[30px] w-[100px] mb-1 font-normal p-2 border-2 border-transparent rounded-[10px] transition duration-500 hover:scale-110 hover:-translate-y-1 hover:border-[#b74b4b] hover:shadow-[0_0_25px_#b74b4b] bg-[#161616]">DEMO</button></Link>
          <Link href="https://github.com/Waseem4100/SIMPLE-CALCULATOR"><button className="projectlink ml-2 h-[30px] w-[100px] mb-1 font-normal p-2 border-2 border-transparent rounded-[10px] transition duration-500 hover:scale-110 hover:-translate-y-1 hover:border-[#b74b4b] hover:shadow-[0_0_25px_#b74b4b] bg-[#161616]">GITHUB</button></Link>
      ...
      <div className="projectCard w-[325px] h-[325px] min-h-[325px] bg-[#161616] rounded-[12px] border-3 border-transparent mt-24 transition duration-500 ml-8 hover:scale-110 hover:-translate-y-1 hover:border-[#b74b4b] hover:shadow-[0_0_25px_#b74b4b]">
        ...
        <div className=" flex gap-16 mt-2 mb-1 ml-8 bg-[#161616]">
          <Link href="https://loginpage-olive-gamma.vercel.app/"><button className="bg-[#161616] h-[30px] w-[100px] mb-1 font-normal p-2    transition duration-500 hover:scale-110 hover:-translate-y-1 hover:border-[#b74b4b] hover:shadow-[0_0_25px_#b74b4b]">DEMO</button></Link>
          <Link href="https://github.com/Waseem4100/log-in-page"><button className="bg-[#161616] ml-2 h-[30px] w-[100px] mb-1 font-normal p-2 border-2 border-transparent rounded-[10px] transition duration-500 hover:scale-110 hover:-translate-y-1 hover:border-[#b74b4b] hover:shadow-[0_0_25px_#b74b4b]">GITHUB</button></Link>
