...
export default function About() {
    ...
    return (
      <div className="AboutSection flex flex-wrap gap-32 mt-24 p-2">
     ...
     <div className="aboutTitle w-[35%] ml-10">
      <h2 className="aboutHeading text-4xl font-semibold">About Me</h2>
      <p className="aboutDescription w-[500px] text-lg opacity-85"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo esse molestiae dignissimos animi facilis dolore voluptates rem laudantium non iusto, odio dolores, repellendus vero iure corporis magni pariatur suscipit! Expedita.</p>
